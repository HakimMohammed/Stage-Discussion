...
export default function Test() {
    ...
    // Handle recorded audio blob if needed
    ...
    const UserProfilePicture = ({ name }) => {
        return (
          <Avatar name={name} size="55" round />
        );
      };
    return (
                                    ...
                                    <div class="row position-relative">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <figure class="me-2 mb-0">
                                                                <UserProfilePicture name={'Amiah Burton'}/>
                                                            </figure>
                                                            <div>
                                                                <h2>Amiah Burton</h2>
                                                            </div>
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" id="chats-tab" data-bs-toggle="tab"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p class="d-none d-sm-block">Parents</p>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                                    ...
                                                                    <li class="chat-item pe-1">
                                                                        <a href="javascript:;"
                                                                            ...
                                                                            <div
                                                                                class="d-flex justify-content-between flex-grow-1 border-bottom">
                                                                                <div>
                                                                                    <p class="text-body fw-bolder">Carl
                                                                                        Henson</p>
                                                                                    <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div
                                                                                    class="d-flex flex-column align-items-end">
                                                                                    <p class="text-muted tx-13 mb-1">05:24
                                                                                        PM</p>
                                                                                    <div
                                                                    ...
                                                                    <li class="chat-item pe-1">
                                                                        <a href="javascript:;"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="d-flex flex-column align-items-end">
                                                                                    <p class="text-muted tx-13 mb-1">2 days
                                                                                        ago</p>
                                                                                </div>
                                                                            </div>
                                                                        </a>
                                                                    ...
                                                                    <li class="chat-item pe-1">
                                                                        <a href="javascript:;"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="d-flex flex-column align-items-end">
                                                                                    <p class="text-muted tx-13 mb-1">4 week
                                                                                        ago</p>
                                                                                </div>
                                                                            </div>
                                                                        </a>
                                                                    ...
                                                                    <li class="chat-item pe-1">
                                                                        <a href="javascript:;"
                                                                            ...
                                                                            <div
                                                                                class="d-flex justify-content-between flex-grow-1 border-bottom">
                                                                                <div>
                                                                                    <p class="text-body fw-bolder">Leonardo
                                                                                        Payne</p>
                                                                                    <div class="d-flex align-items-center">
                                                                                        <i data-feather="image"
                                                                                            class="text-muted icon-md mb-2px"></i>
                                                                                ...
                                                                                <div
                                                                                    class="d-flex flex-column align-items-end">
                                                                                    <p class="text-muted tx-13 mb-1">6:11 PM
                                                                                    </p>
                                                                                    <div
                                                                                        class="badge rounded-pill bg-danger ms-auto">
                                                                                        3</div>
                                                                ...
                                                                <li class="chat-item pe-1">
                                                                    <a href="javascript:;"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div>
                                                                                <p class="text-body">Classe Petite Section</p>
                                                                                <div class="d-flex align-items-center">
                                                                                    {/* <p class="text-muted tx-13">Front-end
                                                                                        Developer</p> */}
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <a href="javascript:;"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div>
                                                                                <p class="text-body">Yaretzi Mayo</p>
                                                                                <div class="d-flex align-items-center">
                                                                                    <p class="text-muted tx-13">Fullstack
                                                                                        Developer</p>
                                                                                </div>
                                                                            </div>
                                                                            <div class="d-flex align-items-end text-body">
                                        ...
                                        <div class="col-lg-8 chat-content">
                                            ...
                                            <div class="chat-footer d-flex">
                                                ...
                                                <div class="d-flex">
                                                    <button type="button" class="btn border btn-icon rounded-circle me-2" data-bs-toggle="tooltip" data-bs-title="Record you voice" onClick={() => { isClicked ? setIsClicked(false) : setIsClicked(true) }}>
                                                        <i data-feather="mic" class="text-muted"></i>
                                                    </button>
                                                </div>
                                                <form class="search-form flex-grow-1 me-2" style={{ marginBottom: 0 }}>
                                                    {isClicked && (
                                                ...
                                                {/* <div>
                                                    <button type="submit" onClick={handleSubmit} class="btn btn-primary btn-icon rounded-circle">
                                                        <i data-feather="send"></i>
                                                    </button>
                                                </div> */}
                                            </div>
